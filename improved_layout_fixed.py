...
def update_table_layout():
    """Update the table layout function in main.py for better visual appearance"""
    
    # The complete, error-free improved function
...
'''
    ...
    new_content = content[:start_idx] + improved_function + "\n\n" + content[end_idx:]
    
    # Create backup
    os.rename('main.py', 'main.py.bak3')
